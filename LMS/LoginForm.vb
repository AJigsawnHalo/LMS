Public Class LoginForm
            ...
            If dr.HasRows Then
                While dr.Read()
                    ...
                    If PassWord2 = PassWordTextBox2M.Text And UserName2 = UserNameTextBox2M.Text Then
                        ...
                        MessageBox.Show("Logged in successfully as " & UserName2, "", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Sub UserNameTextBox2M_Click(sender As Object, e As EventArgs) Handles UserNameTextBox2M.Click
